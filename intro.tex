...
\begin{enumerate}
\item How can \emph{mesh simplification} be done without affecting the \emph{visual apperance} significantly?

\item What are the alternatives to achieve \emph{mesh simplification} with \emph{apperence preservation}?

\item Which alternative gives the best effect considering \emph{performance} and \emph{apperance preservation}?
\end{enumerate}
