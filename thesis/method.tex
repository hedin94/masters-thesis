...
% -------------------------------------------------------
\iffalse
\subsection{Multiple attributes for a vertex} \label{sec:vertex-with-}
...
\begin{figure}[h]
    ...
    \caption{Unwrapping a cylinder. Vertices along seam (red line) need two different texture coordinates}
